...
params:
  prepared_by:
    ...
    input: text
title: "COVID-19 in Lithuania: Age cohort graphs"
---
...
Because the age cohorts given in the two sources do not align,
when calculating COVID rates relative to age cohorts, a smaller
number of larger cohorts is used.
...
knitr::opts_knit$set(base.dir = stringr::str_c(here::here(), "/output/"), base.url = "/covidregionaldatagraphs/") # project root folder
...
lt_aggregate <- download_restful(
  ...
  lt_age_sex_data <- download_excel(
    "https://osp.stat.gov.lt/documents/10180/8416503/Resident_population_sex_and_age_2021.xls",
...
```{r cohort_prevalance_cases_cumulative, echo=FALSE}
per_capita_rates %>%
  group_by(cohort) %>%
