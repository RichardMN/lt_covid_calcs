...
## Bin calculations by weeks as in _Andrews et al._
...
binned_ve_calcs_r2 <- infn_age_bins %>%
  ...
  summarise(mean(ve_vs_r0_r2), sd(ve_vs_r0_r2), sd(r_pop_r0))
...
boot.ci(boot_ve)
knitr::kable(binned_ve_calcs_r2)
```
