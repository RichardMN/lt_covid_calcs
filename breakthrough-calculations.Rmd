...
only consider the population of 20 and above. The vaccine is not available for
...
`r paste0("![](https://osp.stat.gov.lt/documents/10180/8555211/skiepai_amzius_", strftime(today(), "%Y%m%d"),".png)")`
...
```{r vaccine_effectiveness_7d_adults}
